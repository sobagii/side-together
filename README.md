...
유목민들의 아이디어 게르입니다. 사이드 프로젝트 팀이 아이디어, 질문, 결정, 공지를 비공개로 나누고 기록하는 작은 협업 공간입니다.
...
GitHub에 올릴 파일만 빠르게 확인하려면 [GITHUB_UPLOAD_CHECKLIST.md](./GITHUB_UPLOAD_CHECKLIST.md)를 확인하세요.
